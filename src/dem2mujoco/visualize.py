...
def plot_dem_3d(
    ...
    z_min, z_max = np.percentile(Z, clip_percent)
    ...
    figure = go.Figure(data=[go.Surface(x=x, y=y, z=Z, colorscale=colorscale)])
    ...
    if out_html_path:
        figure.write_html(out_html_path, include_plotlyjs="cdn")
    if show_figure:
        figure.show()
